  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titreWrapper}>
        {/* Bouton retour vers l'accueil JE */}
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer} style={styles.scrollViewContent}>
        {filteredEtudes.map((etude, index) => (
          <View key={etude.ID_etude} style={[styles.cadre]}>
            ...
            <Text style={styles.textinfo} numberOfLines={3}>{etude.Description_etude}
            </Text>

            {/* Bouton pour voir l’étude en détail */}
            <TouchableOpacity style={styles.buttonVoirPlus} onPress={() => router.push(`/JE_Etude/${etude.ID_etude}`)}>
      ...
      {/* Bouton + pour ajouter une étude */}
      <TouchableOpacity style={styles.Buttonplus} onPress={() => router.push('/JE_Etude_plus')}>
