...
const JEEveListe = () => {
  ...
  return (
    <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer} style={styles.scrollViewContent} >
          {filteredEvents.map(event => (
            ...
            >
              ...
              <TouchableOpacity style={styles.buttonVoirPlus} onPress={() => router.push(`/JE_Evenement/${event.ID_eve}`)}>
      ...
      {/* Bouton + pour ajouter une event */}
      <TouchableOpacity style={styles.Buttonplus} onPress={() => router.push('/JE_Event_plus')}>
...
const styles = StyleSheet.create({
  ...
  scrollViewContent: {
    ...
    marginBottom: screenHeight * 0.07,  // pour éviter la barre du bas
  },
  scrollContainer: {
