...
const BoutonArticle = ({ Article, router }: TypeArt) => (
  <TouchableOpacity style={styles.boutonArt}
    onPress={() => {
      router.push('/Intervenant_Articles');
    }}>
    <View style={styles.boutonCont}>
      <Image source={require('../../assets/images/autres/Logo article.png')} style={[styles.imageBouton, { width: 100, height: 100, marginRight: 15 }]} />
...
const BoutonEvent = ({ Event, router }: TypeEve) => (
  <TouchableOpacity style={styles.boutonEv}
    onPress={() => {
      router.push('/Intervenant_Evenements');
    }}>
    <View style={styles.boutonCont}>
...
const BoutonEtude = ({ Etude, router }: TypeEtu) => (
  <TouchableOpacity style={styles.boutonEtu}
    onPress={() => {
      router.push('/Intervenant_Etudes');
    }}
  >
    <View style={styles.boutonCont}>
      <Image source={require('../../assets/images/autres/Logo etudes.png')} style={[styles.imageBouton, { width: 111, height: 111, marginRight: 10 }]} />
