...
const Etude = () => {
  ...
  // Fonction pour formater une date en chaîne lisible JJ/MM/AAAA à HHhMM
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer} style={styles.scrollViewContent}>
        <View style={styles.cadre}>
          ...
          <TouchableOpacity onPress={() => router.replace(`../JE_Etude_Liste_Int/${etude.ID_etude}`)} style={styles.bouton_recru}>
            <Text style={styles.txt}>Gérer le recrutement de cette étude</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
      {/* Barre inférieure */}
